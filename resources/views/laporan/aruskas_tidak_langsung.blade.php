        ...
        <div class="card-body">
            <form action="{{ route('laporan.aruskas_tidak_langsung') }}" method="GET" class="row g-3 align-items-end">
                ...
                <div class="col-md-4 d-flex gap-2">
                    ...
                    <a href="{{ route('laporan.aruskas_tidak_langsung.pdf', request()->all()) }}" class="btn btn-danger" target="_blank" title="Cetak PDF">
                        <span data-feather="file-text"></span> PDF
                    </a>
                    <a href="{{ route('laporan.aruskas_tidak_langsung.excel', request()->all()) }}" class="btn btn-success" title="Ekspor Excel">
