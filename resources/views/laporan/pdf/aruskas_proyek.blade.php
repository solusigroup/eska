...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
    <tbody>
        ...
        <tr>
            <td style="padding: 6px; border: 1px solid #ddd; font-weight: bold;">Saldo Kas Awal</td>
        ...
        <tr class="grand-total" style="background-color: #e9ecef; font-weight: bold;">
            <td style="padding: 6px; border: 1px solid #ddd; font-size: 11px;">Saldo Kas Akhir</td>
