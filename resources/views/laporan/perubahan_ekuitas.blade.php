        ...
        <div class="card-body">
            <form action="{{ route('laporan.perubahan_ekuitas') }}" method="GET" class="row g-3 align-items-end">
                ...
                <div class="col-md-4 d-flex gap-2">
                    ...
                    <a href="{{ route('laporan.perubahan_ekuitas.pdf', request()->all()) }}" class="btn btn-danger" target="_blank" title="Cetak PDF">
                        <span data-feather="file-text"></span> PDF
                    </a>
                    <a href="{{ route('laporan.perubahan_ekuitas.excel', request()->all()) }}" class="btn btn-success" title="Ekspor Excel">
