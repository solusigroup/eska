            ...
            <form action="{{ route('laporan.aruskas_konsolidasi') }}" method="GET">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4 d-flex gap-2 align-items-end">
                        ...
                        <a href="{{ route('laporan.aruskas_konsolidasi.pdf', request()->all()) }}" class="btn btn-danger" target="_blank" title="Cetak PDF">
                            <span data-feather="file-text"></span> PDF
                        </a>
                        <a href="{{ route('laporan.aruskas_konsolidasi.excel', request()->all()) }}" class="btn btn-success" title="Ekspor Excel">
